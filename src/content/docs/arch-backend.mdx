...
[Settings → Tools](/docs/tools/#configurable-per-tool-toggles) toggles.
...
This is the first place to look when a session misbehaves. It contains
the host's diagnostic output, not transcripts.
